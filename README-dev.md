# 🛠️ Documentation développeur - theses-batch-dump-datagouv
...
2. Modifiez le fichier de propriétés spécifique au développement local : [application-localhost.properties](file:///c:/Projets/theses-batch-dump-datagouv/src/main/resources/application-localhost.properties).
...
* **Lancer le JAR produit** :
  ```bash
  java -jar target/theses-batch-dump-datagouv-1.0.0.jar
  ```
